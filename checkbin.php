...
function info($ccnum){
	...
	$data = "<tr align=center><td><span class='text-info'>$ccnum</span></td><td><a class='banklink' data-link='".$info[2]."'>".$info[2]."</a></td><td>".$info[3]." ".$info[4]."</td><td>".$info[5]."</td><td>".$info[10]."</td></tr>";
	if(strlen($info[1]) < 2){
