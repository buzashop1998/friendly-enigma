...
{% if btcspeed == '1' %}
<tr><form action='' ><td><center><img alt='' src='images/btc-speed.png'></center></td><td><input type='hidden' class='form-control' id='userIdspeed' value='{{userid}}' /><center> Min. deposit = {{mindeposit}} $</center><br><center><input type='text' class='form-control' id='userIdspeedsum' value='' /> $</center></td><td><center><button type='submit' onclick='depositbtcspeed();' class='btn btn-warning'>Deposit</button></center></td></form></tr>
{% endif %}
