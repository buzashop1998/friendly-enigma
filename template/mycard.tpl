...
<tr><td class='tdCol' style='font-size:12px;'>{{card.cardId}}</td>
<td class='tdCol' style='font-size:12px;'>{{card.cardContent}}</td>
<td class='tdCol' style='font-size:12px;'>{{card.sdate}}</td>
<td class='tdCol' id='cardResult{{card.cardId}}' style='font-size:12px;'>
{% if card.status == '0' %}
