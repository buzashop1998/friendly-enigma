...
<tr>
<td class="center"><span class="label" style="background-color:{{ccnews.color | raw}}">{{ccnews.date | raw}}</span></td>
<td style="color:{{ccnews.color | raw}}" class="text">{{ccnews.text | raw}}</td>
</tr>
{% endfor %}
</tbody></table>
</div></div></div>
